...
$(function() {
	$("#btnList").click(function() {
		location.href="${path}/notice/index.jsp";
	});
	$("#btnEdit").click(function() {
		location.href="${path}/notice_servlet/edit.do?num=${dto.num}";
	});
});
  ...
  <tr>
   ...
   <td colspan="3">
    <c:if test="${dto.filesize > 0}">
     <img src="/tomcatImg/${dto.filename}" style="width: 150px; height: 150px;"><br>
     ${dto.filename}
    </c:if>
   </td>
  </tr>
