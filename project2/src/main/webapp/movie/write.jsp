...
<form name="form1" method="post"
 action="${path}/movie_servlet/insert.do" enctype="multipart/form-data">
<table border="1" style="width: 100%;">
 <tr>
  <td>이름</td>
  <td><input type="hidden" name="writer" id="writer" value="<%=session.getAttribute("userid")%>"><%=session.getAttribute("userid")%></td>
 </tr>
 <tr>
  <td>제목</td>
